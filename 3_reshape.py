...
print(heights_and_ages_arr.size) #length of the array
print(heights_and_ages_arr.shape) #dimension of the array
heights_and_ages_arr=heights_and_ages_arr.reshape(2,45)
print(heights_and_ages_arr) #reshape the array into 2 rows and 45 coloumns
heights_and_ages_arr=heights_and_ages_arr.reshape(-1,2)
print(heights_and_ages_arr)
heights_and_ages_arr=heights_and_ages_arr.reshape(2,-1) 
print(heights_and_ages_arr)
heights_and_ages_arr=heights_and_ages_arr.reshape(-1)#converts into 1d array
print(heights_and_ages_arr)
#output
"""90
(90,)
